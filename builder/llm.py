...
_SYSTEM_PROMPT = (
    ...
    "- Add at least one brand-new pytest test function that fails without your\n"
    "  change. Editing assertions inside an existing test is not enough: the patch\n"
    "  is rejected unless the number of collected tests goes up.\n"
